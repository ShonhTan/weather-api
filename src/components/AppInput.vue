  ...
  <div class="appInput row">
    ...
    <form class="input-group mb-4 col-12 col-sm-6"
      ...
      <div class="input-group-prepend">
        <label class="input-group-text"
               for="inputGroupSelect01">{{ $t('lang.appInput.citylabel') }}</label>
      </div>
      <input type="text"
             class="form-control"
      ...
      <div class="input-group-append" v-if="inputCity!==''">
        <input class="btn btn-outline-secondary text-white"
               type="submit"
               :value="$t('lang.appInput.ok')">
      </div>
    </form>
    ...
    <div class="input-group mb-4 col-12 col-sm-6">
      ...
      <div class="input-group-append">
        <label class="input-group-text"
               for="inputGroupSelect02">{{ $t('lang.appInput.languagelabel') }}</label>
      </div>
    </div> 
  </div>
